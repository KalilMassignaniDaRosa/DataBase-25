...
CREATE TABLE Pessoa(
    ...
    endereco_atual_id INT NOT NULL,
    criado_em TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT pk_pessoa PRIMARY KEY (pessoa_id),
	CONSTRAINT fk_cargo_pessoa FOREIGN KEY (cargo_atual_id) REFERENCES Cargos_Ocupados (cargo_id),
	CONSTRAINT fk_endereco_pessoa FOREIGN KEY (endereco_atual_id) REFERENCES Endereco (endereco_id)
);
...
CREATE TABLE Cargos_Ocupados(
    ...
    CONSTRAINT fk_cargos_pessoa FOREIGN KEY (pessoa_id) REFERENCES Pessoa (pessoa_id)
);
...
CREATE TABLE Dependente(
    ...
    criado_em TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT pk_dependente PRIMARY KEY (pessoa_id),
